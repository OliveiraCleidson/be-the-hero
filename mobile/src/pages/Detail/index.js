...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar com o valor de ${
    ...
    function sendWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=5561996039295&text=${message}`)
    }
    return (
